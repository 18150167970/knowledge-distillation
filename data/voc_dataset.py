...
class VOCBboxDataset:
    ...
    * :obj:`difficult.dtype == numpy.bool`
    ...
    def __init__(self, data_dir, split=opt.datatxt,
        ...
        self.label_names = opt.VOC_BBOX_LABEL_NAMES_all[opt.index]
    ...
    def get_example(self, i):
        ...
        for obj in anno.findall('object'):
            ...
            # print name
            if name not in opt.VOC_BBOX_LABEL_NAMES_all[opt.index]:
                # print 1
                continue
            ...
            # label.append(10)
            # print len(VOC_BBOX_LABEL_NAMES_all)-1
    ...
    def get_example(self, i):
        ...
        for obj in anno.findall('object'):
            ...
            if opt.is_distillation==True:
                ...
                label.append(opt.VOC_BBOX_LABEL_NAMES_all.index(name))
...
VOC_BBOX_LABEL_NAMES_test = opt.VOC_BBOX_LABEL_NAMES
